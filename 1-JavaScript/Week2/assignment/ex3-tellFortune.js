...
function main() {
  ...
  const partnerNames = ['Alice', 'Charlie', 'Paul', 'Ron', 'Diana'];

  const locations = ['Amsterdam', 'New York', 'Paris', 'London', 'Istanbul'];

  const jobTitles = ['doctor', 'teacher', 'architect', 'lawyer', 'journalist'];
